...
public class UserServiceImpl implements UserService, UserDetailsService {
    ...
    public User updateUser(User user, long id) {
        return userRepo.findById(id).map(myUser -> {
    ...
    public void deleteUser(long id) {
        User myUser = userRepo.findById(id).orElseThrow(() -> new UsernameNotFoundException("User not found in the db"));
        log.info("Deleting user {} of the db", myUser.getName());
    ...
    public void addRoleToUser(String username, String roleName) {
        log.info("Saving new role {} into user: {}", roleName, username);
        User user = userRepo.findByUsername(username);
